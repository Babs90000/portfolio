    ...
    <div class="container" id="projects">
        ...
        <div class="row" >
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                if ($row['image_blob']) {
                    echo '<img src="data:image/jpeg;base64,' . base64_encode($row['image_blob']) . '" alt="' . $row['titre']. '" class="card-img-top" style="height: 200px; object-fit: cover;">';
                }
                echo '<div class="card-body">';
                echo '<h4 class="card-title">' . $row['titre']. '</h4>';
                echo '<p class="card-text">' . $row['description']. '</p>';
                echo '<a href="' . $row['url']. '" class="btn btn-primary">Voir le site</a>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
            }
